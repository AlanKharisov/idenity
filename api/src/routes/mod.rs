...
pub fn api_router(state: Arc<AppState>) -> Router<Arc<AppState>> {
    ...
    let protected = Router::new()
        ...
        // NFTs — generous body limits for image uploads
        .route("/nfts", get(nfts::get_nfts))
        .route("/nfts/batch", post(nfts::batch_create_nfts)
        ...
        .route("/nfts/:id", put(nfts::update_nft))
        .route("/nfts/:id", delete(nfts::delete_nft))
        // Posts / feed
